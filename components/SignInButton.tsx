...
export default function SignInButton({ returnTo }: { returnTo?: string } = {}) {
  ...
  return (
    ...
    <a
      href={href}
      className="w-full bg-bungie-blue hover:opacity-90 hover:shadow-[0_0_24px_rgba(0,174,239,0.5)] text-white font-semibold py-3 px-6 rounded-lg transition flex items-center justify-center gap-2"
    >
